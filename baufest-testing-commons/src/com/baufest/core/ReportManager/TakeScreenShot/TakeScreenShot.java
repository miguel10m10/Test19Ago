package src.com.baufest.core.ReportManager.TakeScreenShot;
...
public class TakeScreenShot {
    ...
    public String getScreenshot(WebDriver driver, String screenshotName) throws Exception {
        ...
        String destination = System.getProperty("user.dir") +getXMLfile.GetProperties("screenshots.path")+screenshotName+dateName+".png";
